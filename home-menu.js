    ...
    main(){
        ...
        swipedetect(window, function(swipedir, movedir, distance){
            ...
            if(swipedir == `left` || swipedir == `right` || swipedir == `up` || swipedir == `down`){
                ...
                if(swipedir == `left`) this.deltaY += -175 * -0.04 * distance;
                else if (swipedir == `right`) this.deltaY += 175 * -0.04 * distance;
                else if(swipedir == `up`) this.deltaY += -175 * -0.04 * distance;
                else if (swipedir == `down`) this.deltaY += 175 * -0.04 * distance;
